...
#import "WKWebView+SNSafeScrollTo.h"
...
@implementation WKWebView (SNSafeScrollTo)

- (void)sn_scrollToOffset:(CGFloat)offset
           maxRunloops:(NSUInteger)maxRunloops
       completionBlock:(SNSafeScrollToCompletionBlock)completionBlock {
